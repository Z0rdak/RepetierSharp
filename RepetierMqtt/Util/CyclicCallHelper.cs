...
{
    namespace ALBridgeBuilder.Utils
    {
        public static class CyclicCallHelper
        {

            public static Timer CreateCyclicCall(Action call, int interval = 5000, int Timeout = Timeout.Infinite)
            {
                Timer timer = null;
