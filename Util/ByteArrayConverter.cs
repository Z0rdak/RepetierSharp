...
namespace RepetierSharp.Util
{
    ...
    internal class ByteArrayConverter : JsonConverter<byte[]>
    {
        ...
        internal static JsonSerializerOptions ByteArraySerializerOptions { get => ByteArraySerializerOption(); }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        internal static JsonSerializerOptions ByteArraySerializerOption()
        {
    ...
    internal class DeserialisationHelper
    {
