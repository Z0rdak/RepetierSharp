...
namespace RepetierSharp.Config
{
    ...
    public class Extruder
    {
        ...
        [JsonPropertyName("eJerk")] public double EJerk { get; set; }

        [JsonPropertyName("extrudeSpeed")] public double ExtrudeSpeed { get; set; }

        [JsonPropertyName("filamentDiameter")] public double FilamentDiameter { get; set; }
        ...
        [JsonPropertyName("maxSpeed")] public double MaxSpeed { get; set; }
        ...
        [JsonPropertyName("retractSpeed")] public double RetractSpeed { get; set; }

        [JsonPropertyName("supportTemperature")]
        public bool SupportTemperature { get; set; }

        [JsonPropertyName("tempMaster")] public int TempMaster { get; set; }

        [JsonPropertyName("temperatures")] public List<Temperature> Temperatures { get; set; }

        [JsonPropertyName("toolDiameter")] public double ToolDiameter { get; set; }
