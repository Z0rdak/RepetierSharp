...
namespace RepetierSharp.Config
{
    public class General
    {
        ...
        [JsonPropertyName("doorHandling")]
        public int DoorHandling { get; set; }
        ...
        [JsonPropertyName("g9091OverrideE")]
        public bool G9091OverrideE { get; set; }
        ...
        [JsonPropertyName("numFans")]
        public int NumFans { get; set; }

        [JsonPropertyName("pauseHandling")]
        public int PauseHandling { get; set; }

        [JsonPropertyName("pauseSeconds")]
        public int PauseSeconds { get; set; }

        [JsonPropertyName("printerHomepage")]
        public string PrinterHomepage { get; set; }

        [JsonPropertyName("printerManual")]
        public string PrinterManual { get; set; }
        ...
        [JsonPropertyName("softwareLight")]
        public bool SoftwareLight { get; set; }
        ...
        [JsonPropertyName("useModelFromSlug")]
