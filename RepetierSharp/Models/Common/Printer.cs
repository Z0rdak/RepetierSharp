...
namespace RepetierSharp.Models
{
    public class Printer
    {
        ...
        [JsonPropertyName("linesSend")] public int LinesSend { get; set; }

        [JsonPropertyName("name")] public string PrinterName { get; set; }

        [JsonPropertyName("ofLayer")] public int LayerCount { get; set; }

        [JsonPropertyName("online")] public int IsOnline { get; set; }

        [JsonPropertyName("pauseState")] public int PauseState { get; set; }
