...
namespace RepetierSharp.Models
{
    ...
    /// </summary>
    public class ModelResponse : IRepetierResponse
    {
        [JsonPropertyName("analysed")] public int Analysed { get; set; }

        [JsonPropertyName("created")] public long Created { get; set; }

        [JsonPropertyName("extruderUsage")] public List<double> ExtruderUsage { get; set; }
        ...
        [JsonPropertyName("volumeUsage")] public List<double> VolumeUsage { get; set; }
