...
namespace RepetierSharp.Config
{
    public class Webcam
    {
        ...
        [JsonPropertyName("reloadInterval")] public double ReloadInterval { get; set; }
        ...
        [JsonPropertyName("snapshotY")] public double SnapshotY { get; set; }

        [JsonPropertyName("staticUrl")] public string StaticUrl { get; set; }
