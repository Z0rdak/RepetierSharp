...
namespace RepetierSharp.Config
{
    public class Connection
    {
        ...
        [JsonPropertyName("lcdTimeMode")]
        public int LcdTimeMode { get; set; }
    ...
    public class SerialConnection
    {
        ...
        [JsonPropertyName("connectionDelay")]
        ...
        [JsonPropertyName("usbreset")]
        public int UsbReset { get; set; }
