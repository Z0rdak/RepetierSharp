...
namespace RepetierSharp.Models
{
    public class PrinterState
    {
        ...
        public int ActiveExtruder { get; set; }
        ...
        public double FlowMultiplier { get; set; }
        ...
        public List<PrinterTemperature> Heatedbeds { get; set; }

        [JsonPropertyName("heatedChambers")]
        public List<PrinterTemperature> HeatedChambers { get; set; }
        ...
        public bool IsSDCardMounted { get; set; }
